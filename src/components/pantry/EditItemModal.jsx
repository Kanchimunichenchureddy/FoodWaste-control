...
const EditItemModal = ({ item, onClose, onUpdate, onConsume }) => {
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="glass-card bg-white max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slide-up">
                ...
                <div className="flex items-center justify-between p-6 border-b border-emerald-100">
                    <h2 className="text-2xl font-black text-emerald-950">Edit Item</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex gap-3 pt-4">
                        <button
                            type="button"
                            onClick={() => {
                                if (window.confirm('Mark this item as fully consumed?')) {
                                    onConsume(item.id);
                                    onClose();
                                }
                            }}
                            className="bg-emerald-100 hover:bg-emerald-200 text-emerald-700 px-4 py-2 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2"
                        >
